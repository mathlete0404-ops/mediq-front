      ...
      <div className="mb-6 p-4 bg-gray-50 rounded-lg">
        ...
        <p className="text-base font-medium text-gray-900">{analysisResult.symptom}</p>
          ...
          <HospitalList
            ...
            specialty={analysisResult?.department || analysisResult?.estimatedDisease}
            isEmergency={analysisResult?.isEmergency}
...
// Render MapModal when ChatInterface is recommending hospitals
// Place outside of motion.div to avoid clipping
// Attach MapModal under ChatInterface component
// export function ChatInterfaceWithMap(props) {
